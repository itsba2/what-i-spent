      ...
      selectFromResult: ({ data, isLoading, isSuccess }) => {
        const filteredData =
          data?.filter((expense) => {
            ...
            const amountLargerThanMin = filterOptions.minAmount.length
              ? parseFloat(expense.amount) >= filterOptions.minAmount
              : true;
            const amountSmallerThanMax = filterOptions.maxAmount.length
              ? parseFloat(expense.amount) <= filterOptions.maxAmount
              : true;
            const selectedCurrency =
              filterOptions.currency === "Any"
                ? true
        ...
        const filteredData =
          data?.filter((earning) => {
            ...
            const dateBeforeEndDate = dayjs
              ...
              .isBefore(filterOptions.endDate);
            const amountLargerThanMin = filterOptions.minAmount.length
              ? parseFloat(earning.amount) >= filterOptions.minAmount
              : true;
            const amountSmallerThanMax = filterOptions.maxAmount.length
              ? parseFloat(earning.amount) <= filterOptions.maxAmount
              : true;
            const selectedCurrency =
              filterOptions.currency === "Any"
                ? true

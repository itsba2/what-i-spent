...
const Account = () => {
    ...
    const handleChangeCurrencyPref = async () => {
        try {
            const response = await updateCurrencyPref(
                currentUser.id,
                currencyPref
            )
            setFeedback({
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            if (
                ...
                data.newPassword === data.newConfirm
            ) {
                        ...
                        <AccordionDetails>
                            ...
                            >
                                ...
                                <Alert
                                    severity="info"
                                    sx={{
                                        display: showCurrentPasswordField
                                            ? "flex"
                                            : "none",
                                    }}
                                >
                                    Confirm your current password to apply
                                    changes
                                </Alert>
                                <Controller
                                ...
                                <Button
                                    variant="contained"
                                    onClick={() =>
                                        toggleCurrentPasswordField(true)
                                    }
                                    sx={{
                                        alignSelf: "center",
                                        width: "fit-content",
                                ...
                                >
                                    <Button
                                        variant="outlined"
                                        onClick={() =>
                                            toggleCurrentPasswordField(false)
                                        }
                                        sx={{
                                            alignSelf: "center",
                                            width: "fit-content",
